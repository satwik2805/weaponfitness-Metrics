...
import { View, Text, ScrollView, StyleSheet, TouchableOpacity, Image, RefreshControl, Dimensions, Animated, Easing, Platform } from "react-native";
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        {/* Linear XP Progress UI */}
        <View style={styles.xpCard}>
          <View style={styles.xpTextRow}>
            <View>
              <Text style={styles.xpLevelLabel}>LEVEL</Text>
              <Text style={styles.xpLevelValue}>{gamification.level}</Text>
            </View>
            <View style={{ alignItems: 'flex-end' }}>
              <Text style={styles.xpTotalText}>{gamification.xp_in_level} / {gamification.xp_needed_for_level}</Text>
          ...
          <View style={styles.progressContainer}>
            <View style={styles.progressTrack}>
              <LinearGradient
                ...
                style={[styles.progressBar, { width: `${(gamification.progress || 0) * 100}%` }]}
              />
            </View>
          </View>
          ...
          <View style={styles.xpFooter}>
            ...
            <Text style={styles.xpRemainingText}>
              {(gamification.xp_needed_for_level || 0) - (gamification.xp_in_level || 0)} XP to Next Level
            </Text>
          </View>
        </View>
