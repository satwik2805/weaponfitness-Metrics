...
export default function TraineeHomeScreen() {
  ...
  const [gamification, setGamification] = useState({
    ...
    rewards: { shoutout: "" },
    consistency: {
      daily: { attendance: false, workout: false, sleep: false, attendance_weekly_avg: 0, workout_weekly_avg: 0, sleep_weekly_avg: 0 },
      weekly: { count: 0, days: [] }
    }
  });
          ...
          <View style={styles.eliteCircleRow}>
            ...
            <View style={styles.eliteCircleWrapper}>
              <View style={styles.svgContainer}>
                ...
                <View style={styles.circleInnerContent}>
                  <FontAwesome5 name="dumbbell" size={10} color={gamification.consistency?.daily?.workout_weekly_avg > 0 ? "#FFD600" : "rgba(255,255,255,0.1)"} />
          ...
          <>
            ...
            <View style={styles.workoutContainer}>
              ...
              {!planActive ? (
                ...
                todaysWorkouts.map((w) => (
                  ...
                  >
                    <FontAwesome5 name="dumbbell" size={20} color={colors.accent} />
            ...
            >
              <View style={styles.nutritionMain}>
                ...
                <FontAwesome5 name="fire" size={24} color={colors.accent} />
              </View>
